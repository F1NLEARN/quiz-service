...
COPY quiz-service/gradle gradle
COPY quiz-service/gradlew gradlew
COPY quiz-service/build.gradle build.gradle
COPY quiz-service/settings.gradle settings.gradle
